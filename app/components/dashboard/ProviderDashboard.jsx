	...
	return (
		<div className='dashboard'>
			...
			<div className='quick-stats'>
				...
				<div className='stat-card'>
					<h3>Total Modems</h3>
					<p>{stats.totalModems}</p>
				</div>
				<div className='stat-card'>
					<h3>Online Modems</h3>
					<p className='text-success'>{stats.online}</p>
				</div>
				<div className='stat-card'>
					<h3>Offline Modems</h3>
					<p className='text-error'>{stats.offline}</p>
				</div>
				<div className='stat-card'>
					<h3>Total Usage</h3>
					<p>{stats.totalUsage.toFixed(1)} GB</p>
				</div>
				<div className='stat-card'>
					<h3>Active Alerts</h3>
